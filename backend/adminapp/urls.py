...
from .views import JobPostingView,AddStateAPIView,AddCityAPIView,IndustryAPIView,RoleAPIView,JobApplicationView,SuperuserLoginView
...
urlpatterns = [
    ...
    path('states/', AddStateAPIView.as_view(), name='add_state'),  # POST method to create state
